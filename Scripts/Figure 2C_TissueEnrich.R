...
# Raw data
expressionData<-read.table('Dog_11tissue_RNA_FPKM_raw.txt',header=TRUE,row.names=1,sep='\t')
...
head(assay(output))
write.csv(assay(output), 'Dog_11tissue_RNA_FPKM_raw_tiEnrich_4fold_group2-3.txt', row.names=FALSE, quote=FALSE)
